...
--12. list the topgrossing movies of all genres
--13. list the best rated movies of all the genres.
--14. list the genre with most number of media clips
--15. list the most influential person in the database(ie present in most number of media clips or songs)
